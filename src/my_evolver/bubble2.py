...
for i in range(3):
    ...
    refinement()
# vol = constraint.compute_constraint(Verts, Faces[np.array(global_state.BODIES[0].get_facet_list())-global_state.facet_diff],Signs = global_state.BODIES[0].get_facet_sign())
# print(vol)
