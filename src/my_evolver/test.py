...
RMAX = 0.3535533906   # minimum radius for height
ZMAX = 1.0
...
vertex_list = [
    ...
    [[0.25, 0, 0.25],True,boundary2],  # 9
    [[0.75, 0, 0.25],True,boundary2],  # 10
    [[0.75, 1, 0.25],True,boundary1],  # 11
    [[0.25, 1, 0.25],True,boundary1],  # 12
    [[0.25, 0, 0.75],True,boundary2],  # 13
    [[0.75, 0, 0.75],True,boundary2],  # 14
    [[0.75, 1, 0.75],True,boundary1],  # 15
    [[0.25, 1, 0.75],True,boundary1],  # 16
]
...
edge_list = [
    ...
    [9,10,True,boundary2], [10,11], [11,12,True,boundary1], [12,9],       # 13–16: 小立方体底
    [13,14,True,boundary2], [14,15], [15,16,True,boundary1], [16,13],     # 17–20: 小立方体顶
    
    [9,13], [10,14], [11,15], [12,16],      # 21–24: 小立方体柱
